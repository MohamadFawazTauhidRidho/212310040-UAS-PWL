...
import popup from "../assets/barber.jpg";
...
export default function Modal() {
  ...
  const calculateBarbers = () => {
    ...
    const maxPelangganPerBarber = 10;

    const barberYangDibutuhkan = Math.ceil(
      totalPelanggan / maxPelangganPerBarber
    );
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center py-14 2xl:space-y-8 space-y-4 max-w-4xl mx-auto ">
        ...
        <h2 className="2xl:text-4xl text-2xl font-bold tracking-wide">
          KALKULATOR
        </h2>
        ...
        <div className="modal">
          ...
          <div className="modal-content">
            ...
            <div className="mt-4 text-center">
              <img src={popup} alt="Tukang Cukur" className="mx-auto mb-4" />
